...
const Detail = (props) => {
  ...
  const hasWifi = props.hotel.listingAmenities.find(item => (item.name === "Wifi" && item.isPresent === true));
  const hasAC = props.hotel.listingAmenities.find(item => (item.name === "Air conditioning" && item.isPresent === true));
  const haspatio = props.hotel.listingAmenities.find(item => (item.name === "Patio or balcony" && item.isPresent === true));
  const hasTV = props.hotel.listingAmenities.find(item => (item.name === "TV" && item.isPresent === true));
  const hasWorkspace = props.hotel.listingAmenities.find(item => (item.name === "Dedicated workspace" && item.isPresent === true));
  const hasSmoke = props.hotel.listingAmenities.find(item => (item.name === "Smoke alarm" && item.isPresent === true));
  const hasPool = props.hotel.listingAmenities.find(item => (item.name === "Pool" && item.isPresent === true));
  const hasBeach = props.hotel.listingAmenities.find(item => (item.name === "Beachfront" && item.isPresent === true));
    ...
    <div className="box">
      <div className="d-flex justify-content-between price">
        <div className="flex-column">
          <div className="name">{props.hotel.roomType} hosted by {props.hotel.primaryHost.firstName}</div>
          <div className="detail">{props.hotel.guestControls.personCapacity} guests · {props.hotel.bedroomLabel} · {props.hotel.bedLabel} · {props.hotel.bathroomLabel}</div>
        </div>
        <div><img className="Rimage" src={props.hotel.primaryHost.thumbnailUrl} />
        </div>
      </div>
      <hr />
      <div className="d-flex">
        <div className="svg">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block', height: 28, width: 28, fill: 'currentcolor' }}>
        ...
        <div className="flex-column Amargin">
          ...
          <div className="Sdetail">You can check in with the building staff.</div>
        </div>
      </div>
      <br />
      <div className="d-flex">
        ...
        <div className="flex-column Amargin">
          ...
          <div className="Sdetail">92% of recent guests gave the check-in process a 5-star rating.</div>
        </div>
      </div>
      <br />
      <div className="d-flex">
        ...
        <div className="flex-column Amargin">
          ...
          <div className="Sdetail">Your own room in a home, plus access to shared spaces.</div>
        </div>
      </div>
      <div>
        <hr />
        <div>
          ...
          <br />
          <p classs="para">{props.hotel.sectionedDescription.description.split('\n\n')[0]}...</p>
          <span className="detail" style={{ fontWeight: "600", cursor: "pointer" }} onClick={() => handleClick()}>
            Learn more...
          </span>
        </div>
      </div>
          ...
          <ul className="list-unstyled">
            <li>
              <div className="d-flex mt-2 p-1">
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" __cporiginalvalueofinnerhtml="<path d=&quot;M16 20.33a3.67 3.67 0 1 1 0 7.34 3.67 3.67 0 0 1 0-7.34zm0 2a1.67 1.67 0 1 0 0 3.34 1.67 1.67 0 0 0 0-3.34zM16 15a9 9 0 0 1 8.04 4.96l-1.51 1.51a7 7 0 0 0-13.06 0l-1.51-1.51A9 9 0 0 1 16 15zm0-5.33c4.98 0 9.37 2.54 11.94 6.4l-1.45 1.44a12.33 12.33 0 0 0-20.98 0l-1.45-1.45A14.32 14.32 0 0 1 16 9.66zm0-5.34c6.45 0 12.18 3.1 15.76 7.9l-1.43 1.44a17.64 17.64 0 0 0-28.66 0L.24 12.24c3.58-4.8 9.3-7.9 15.76-7.9z&quot; />" __cpp={1} style={{ display: 'block', height: 24, width: 24, fill: 'currentcolor' }}><path d="M16 20.33a3.67 3.67 0 1 1 0 7.34 3.67 3.67 0 0 1 0-7.34zm0 2a1.67 1.67 0 1 0 0 3.34 1.67 1.67 0 0 0 0-3.34zM16 15a9 9 0 0 1 8.04 4.96l-1.51 1.51a7 7 0 0 0-13.06 0l-1.51-1.51A9 9 0 0 1 16 15zm0-5.33c4.98 0 9.37 2.54 11.94 6.4l-1.45 1.44a12.33 12.33 0 0 0-20.98 0l-1.45-1.45A14.32 14.32 0 0 1 16 9.66zm0-5.34c6.45 0 12.18 3.1 15.76 7.9l-1.43 1.44a17.64 17.64 0 0 0-28.66 0L.24 12.24c3.58-4.8 9.3-7.9 15.76-7.9z" __cpp={1} /></svg>
                </div>
                <div className="ms-3 amenity-text" style={{ textDecoration: hasWifi ? "none" : "line-through" }}>Wifi</div>
              </div>
            </li>
            <li>
              <div className="d-flex mt-2 p-1">
                ...
                <div className="ms-3 amenity-text" style={{ textDecoration: hasAC ? "none" : "line-through" }}>Air conditioning</div>
              </div>
            </li>
            <li>
              <div className="d-flex mt-2 p-1">
                ...
                <div className="ms-3 amenity-text" style={{ textDecoration: haspatio ? "none" : "line-through" }}>Patio or balcony</div>
              </div>
            </li>
            <li>
              <div className="d-flex mt-2 p-1">
                ...
                <div className="ms-3 amenity-text" style={{ textDecoration: hasBeach ? "none" : "line-through" }}>Beach Access</div>
              </div>
            </li>
          </ul>
        </div>
          ...
          <ul className="list-unstyled">
            ...
            <li>
              <div className="d-flex mt-2 p-1">
                ...
                <div className="ms-3 amenity-text" style={{ textDecoration: hasWorkspace ? "none" : "line-through" }}>Dedicated Workspace</div>
              </div>
            </li>
            <li>
              <div className="d-flex mt-2 p-1">
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block', height: 24, width: 24, fill: 'currentcolor' }}><path d="M9 29v-2h2v-2H6a5 5 0 0 1-5-4.78V8a5 5 0 0 1 4.78-5H26a5 5 0 0 1 5 4.78V20a5 5 0 0 1-4.78 5H21v2h2v2zm10-4h-6v2h6zm7-20H6a3 3 0 0 0-3 2.82V20a3 3 0 0 0 2.82 3H26a3 3 0 0 0 3-2.82V8a3 3 0 0 0-2.82-3z" />
                  </svg>
                </div>
                <div className="ms-3 amenity-text" style={{ textDecoration: hasTV ? "none" : "line-through" }}>TV</div>
              </div>
            </li>
            <li>
              <div className="d-flex mt-2 p-1">
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block', height: 24, width: 24, fill: 'currentcolor' }}><path d="M24 26c.99 0 1.95.35 2.67 1 .3.29.71.45 1.14.5H28v2h-.23a3.96 3.96 0 0 1-2.44-1A1.98 1.98 0 0 0 24 28c-.5 0-.98.17-1.33.5a3.98 3.98 0 0 1-2.67 1 3.98 3.98 0 0 1-2.67-1A1.98 1.98 0 0 0 16 28c-.5 0-.98.17-1.33.5a3.98 3.98 0 0 1-2.67 1 3.98 3.98 0 0 1-2.67-1A1.98 1.98 0 0 0 8 28c-.5 0-.98.17-1.33.5a3.96 3.96 0 0 1-2.44 1H4v-2h.19a1.95 1.95 0 0 0 1.14-.5A3.98 3.98 0 0 1 8 26c.99 0 1.95.35 2.67 1 .35.33.83.5 1.33.5.5 0 .98-.17 1.33-.5A3.97 3.97 0 0 1 16 26c.99 0 1.95.35 2.67 1 .35.33.83.5 1.33.5.5 0 .98-.17 1.33-.5A3.98 3.98 0 0 1 24 26zm0-5c.99 0 1.95.35 2.67 1 .3.29.71.45 1.14.5H28v2h-.23a3.96 3.96 0 0 1-2.44-1A1.98 1.98 0 0 0 24 23c-.5 0-.98.17-1.33.5a3.98 3.98 0 0 1-2.67 1 3.98 3.98 0 0 1-2.67-1A1.98 1.98 0 0 0 16 23c-.5 0-.98.17-1.33.5a3.98 3.98 0 0 1-2.67 1 3.98 3.98 0 0 1-2.67-1A1.98 1.98 0 0 0 8 23c-.5 0-.98.17-1.33.5a3.96 3.96 0 0 1-2.44 1H4v-2h.19a1.95 1.95 0 0 0 1.14-.5A3.98 3.98 0 0 1 8 21c.99 0 1.95.35 2.67 1 .35.33.83.5 1.33.5.5 0 .98-.17 1.33-.5A3.97 3.97 0 0 1 16 21c.99 0 1.95.35 2.67 1 .35.33.83.5 1.33.5.5 0 .98-.17 1.33-.5A3.98 3.98 0 0 1 24 21zM20 3a4 4 0 0 1 4 3.8V9h4v2h-4v5a4 4 0 0 1 2.5.86l.17.15c.3.27.71.44 1.14.48l.19.01v2h-.23a3.96 3.96 0 0 1-2.44-1A1.98 1.98 0 0 0 24 18c-.5 0-.98.17-1.33.5a3.98 3.98 0 0 1-2.67 1 3.98 3.98 0 0 1-2.67-1A1.98 1.98 0 0 0 16 18c-.5 0-.98.17-1.33.5a3.98 3.98 0 0 1-2.67 1 3.98 3.98 0 0 1-2.67-1A1.98 1.98 0 0 0 8 18c-.5 0-.98.17-1.33.5a3.96 3.96 0 0 1-2.44 1H4v-2h.19a1.95 1.95 0 0 0 1.14-.5A3.98 3.98 0 0 1 8 16c.99 0 1.95.35 2.67 1 .35.33.83.5 1.33.5.5 0 .98-.17 1.33-.5a3.96 3.96 0 0 1 2.44-1H16v-5H4V9h12V7a2 2 0 0 0-4-.15V7h-2a4 4 0 0 1 7-2.65A3.98 3.98 0 0 1 20 3zm-2 13.52.46.31.21.18c.35.31.83.49 1.33.49a2 2 0 0 0 1.2-.38l.13-.11c.2-.19.43-.35.67-.49V11h-4zM20 5a2 2 0 0 0-2 1.85V9h4V7a2 2 0 0 0-2-2z" /></svg>
                </div>
                <div className="ms-3 amenity-text" style={{ textDecoration: hasPool ? "none" : "line-through" }}>Pool</div>
              </div>
            </li>
          </ul>
        </div>
      ...
      <div className="row">
        <Container className="splide-container" >
          <Splide
                ...
                <Card className='swiper-bed'>
                  <Card.Body>
                    <div className='svg-container'>
                      <span>
                        <svg
                          ...
                          role="presentation"
                          focusable="false"
                          style={{ height: 24, width: 24, fill: 'currentcolor' }}>
                    ...
                    <div className="pt-3">
                      ...
                      <div>{room.beds[0].type === 'king_bed' ? <span>King Bed</span> : room.beds[0].type === 'queen_bed' ? <span>Queen Bed</span> : <span>Double Bed</span>}
                      {room.beds.map((bed) => (
                        bed.type === 'crib' ? <span> & Crib</span> : <span></span>
                      ))}
                      </div>
                    </div>
                  </Card.Body>
      ...
      <Google lat={props.hotel.location.lat} lng={props.hotel.location.lng}/>
    </div>
  )
}

export default Detail
{/* {props.hotel.listingRooms.map((bed) => {
              return (
                <Container className=''>
                  <SwiperSlide id='swiperBed'>
                    <Card>
                      <Card.Body>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block', height: 24, width: 24, fill: 'currentcolor' }}><path d="M28 2a2 2 0 0 1 2 1.85v9.99l1.85 5.54a3 3 0 0 1 .11.46l.03.24.01.24V30h-2v-2H2v2H0v-9.68a3 3 0 0 1 .09-.71l.06-.23L2 13.84V4a2 2 0 0 1 1.7-1.98L3.85 2H4zm2 20H2v4h28zm-1.39-6H3.4l-1.34 4h27.9zM28 4H4v10h2v-4a2 2 0 0 1 1.85-2H24a2 2 0 0 1 2 1.85V14h2zm-13 6H8v4h7zm9 0h-7v4h7z" />
                        </svg>
                        {bed.beds[0].type}
                      </Card.Body>
                    </Card>
